 ...
 */
mc.WorldBossBattleScreen = mc.BattleScreen.extend({
    _totalOtherDamageForDisplaying: 0,
    _totalOtherPlayerSourceDamage:0,
    _isBossAlreadyDead:false,

    getPreLoadURL: function () {
        return mc.resource.getBattlePreLoadURLs(mc.GameData.worldBossInBattle);
    },
    ...
    initResources: function () {
        ...
        mc.GameData.playerInfo.setCurrentPartInBattle(worldBossInBattle);
        var battleView = this._battleView = worldBossInBattle.createBattleViewRefactor().showTempBlackPanel(false);
        battleView.preLoadBattleEffect(worldBossInBattle.getArrayAllCreatureIndex());
        ...
        battleField.addBattleListener(mc.BattleFieldRefactor.EVENT_BATTLEFIELD_END, function () {
            ...
            if (winGroupId === mc.const.TEAM_RIGHT) {
                ...
                mc.protocol.finishWorldBossBattle(this._getTotalWorldBossIncur(), arrCreatureStatus, false, function (result) {
                ...
                mc.protocol.finishWorldBossBattle(this._getTotalWorldBossIncur(), arrCreatureStatus, false, function () {
                    mc.view_utility.hideLoadingDialogById(loadingId);
                    screen._showDialogBattleEnd();
                });
            }
        ...
        battleField.addBattleListener(mc.BattleFieldRefactor.EVENT_BATTLEFIELD_REFRESH_TURNS, function (data) {
            ...
            if( !stopSubmitDamage && deltaIncur > 0){
                mc.protocol.submitDamageWithWorldBoss(deltaIncur,function(result){
                }.bind(this));
            }
        }.bind(this));
                ...
                if( result.param["hp"] ){
                    if( result.param["gameHeroName"] != mc.GameData.playerInfo.getName() ){
                        ...
                        if (boss) {
                            ...
                            var otherPlayerSourceDamage = mc.GameData.worldBossSystem.getTotalOtherPlayerDamage();
    ...
    onScreenShow: function () {
        new mc.DialogBattleStart(mc.GameData.worldBossInBattle, function () {
        ...
        bb.sound.playMusic(mc.GameData.worldBossInBattle.getBackgroundMusic());
    },
