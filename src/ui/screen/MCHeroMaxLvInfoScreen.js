...
mc.HeroMaxLvInfoScreen = mc.Screen.extend({
    _heroInfo : null,
    _heroList : null,

    ctor: function (heroesList,index) {
        this._super();
        this.setHero(heroesList,index);
    },
    ...
    _loadHero: function (viewHeroInfo) {
        ...
        var node  = mc.loadGUI(res.layer_hero_max_lv_info);
        this.addChild(node);
    ...
    getScreenId: function () {
        return mc.GUIState.ID_SCREEN_HERO_MAX_LV_INFO;
    }
