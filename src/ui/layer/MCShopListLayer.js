...
mc.ShopListLayer = mc.MainBaseLayer.extend({
    ...
    ctor: function (parseNode) {
        ...
        var arrMiddleURL = [
            "icon_promotionshop", "ico_relicshop", "ico_gemshop", "ico_packageshop", "ico_arenashop", "ico_chaosshop", "ico_bloodshop"
        ];
        var arrMiddleLbl = [
            "Promotion Shop", "Relic Shop", "Bless Shop", "Common Shop", "Arena Shop", "Chaos Shop", "Blood Shop"
        ];

        var arrShopCategoryId = [mc.ShopManager.SHOP_PROMOTION, mc.ShopManager.SHOP_RELIC, blessShopId, mc.ShopManager.SHOP_COMMON, mc.ShopManager.SHOP_ARENA, mc.ShopManager.SHOP_CHAOS, mc.ShopManager.SHOP_BLOOD];
