 ...
 */
mc.ArenaRecordLayer = mc.LoadingLayer.extend({
    ...
    _reloadRecord: function (cell, recordInfo) {
        ...
        if(mc.enableReplaceFontBM())
        {
            ...
            lblGainLeague = mc.view_utility.replaceBitmapFontAndApplyTextStyle(lblGainLeague);
            mc.view_utility.applyArenaPointStyle(lblGainLeague);
    ...
    getLayerId: function () {
        return mc.MainScreen.LAYER_ARENA_RECORD;
    },
